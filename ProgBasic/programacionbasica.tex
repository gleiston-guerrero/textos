...
<<<<<<< Updated upstream
					...
					\AcadBubble{Para su Consideración}{%
...
=======
					Asimismo, el programador participa activamente en la validación y mejora de los procesos organizacionales al identificar inconsistencias, redundancias y oportunidades de optimización durante el desarrollo del sistema. La implementación técnica obliga a examinar cada paso del proceso, lo que permite proponer mejoras basadas en la capacidad del software para gestionar flujos de trabajo de forma más eficiente, segura y consistente~\cite{irani2003, Arvanitou2020Software}.  
					
					\AcadBubble{Para su Consideración}{%
						El programador es responsable de garantizar la calidad del sistema mediante la aplicación de buenas prácticas de diseño, pruebas, documentación, refactorización y mantenimiento. Su intervención asegura que el software sea confiable, extensible y alineado con los objetivos institucionales, contribuyendo con ello al funcionamiento integral del sistema de información~\cite{Abid2020Years, lima2023}.  
>>>>>>> Stashed changes
					}
...
=======
					En síntesis, la evolución desde automatización hacia digitalización y transformación digital representa una progresión donde la tecnología deja de ser un soporte operativo para convertirse en un elemento estratégico de la organización. El ingeniero de sistemas participa activamente en este proceso mediante el desarrollo de software, la integración de plataformas y la implementación de soluciones que respondan a los desafíos del entorno digital~\cite{gonzalez-varona2024, Omol2024Organizational}. 
>>>>>>> Stashed changes
...
=======
					La información surge cuando los datos son procesados, estructurados o contextualizados de manera que adquieren relevancia para un usuario o una actividad. Este procesamiento puede incluir cálculos, clasificaciones, comparaciones, transformaciones o agregaciones~\cite{Dammann2019Data, Zins2007Conceptual, Marchionini2023Information}. La información constituye la base para la toma de decisiones y la ejecución de acciones dentro de una organización.  
>>>>>>> Stashed changes
...
>>>>>>> Stashed changes
					...
					\subsubsection{Información: contexto y significado}
						...
						\AcadBubble{Importante}{%
<<<<<<< Updated upstream
							La información se convierte en un recurso estratégico para organizaciones gracias a su capacidad de apoyar decisiones, automatizar procesos, mejorar la eficiencia organizacional y orientar políticas o acciones informadas. En entornos digitales y de sistemas de información, la generación de información pertinente depende de la calidad de los datos, la adecuación de los algoritmos de procesamiento y la correcta implementación del software que transforma esos datos en insumos útiles para la toma de decisiones~\cite{Horvitz2020Data, silwattananusarn2012}.  .
						}
					...
					\subsubsection{Conocimiento: reglas, estructuras y experiencia}
						...
						En ingeniería de sistemas, el conocimiento se manifiesta como reglas de negocio, políticas organizacionales, modelos de decisión o patrones de comportamiento que guían el funcionamiento del software. Por ejemplo, un sistema académico no solo almacena datos de estudiantes e información de calificaciones; también incorpora conocimiento institucional al aplicar reglas como “aprobar con mínimo 7/10”, “permitir matrícula si no existen deudas” o “generar alertas si el estudiante reprueba tres asignaturas consecutivas”. Estas reglas, diseñadas a partir de experiencia y normativas, permiten que el sistema actúe de manera coherente y confiable~\cite{Bernstein2009Data}.
						
						El conocimiento también se asocia con estructuras mentales y modelos que permiten interpretar la información de manera más profunda. Mientras la información responde al ``qué'', el conocimiento responde al ``por qué'' y ``para qué''. De esta forma, un sistema de información no solo debe presentar datos, sino proveer mecanismos para generar conocimiento útil para gestores, analistas y tomadores de decisiones~\cite{Dammann2019Data,williams2014}.  
						
						La literatura identifica el conocimiento como algo más que datos procesados: es una entidad emergente que requiere interpretación, contexto, experiencia o reglas explícitas -- atributos humanos o estructurales -- para existir. Por ello, la calidad de los datos y la pertinencia del procesamiento influyen directamente en la confiabilidad del conocimiento generado~\cite{Calzati2025Ecosystemic, Cato2020Transforming}. Bajo este enfoque, el conocimiento es esencial para retroalimentar sistemas inteligentes y procesos de mejora continua dentro de organizaciones modernas. Un sistema que aprende de errores, patrones o tendencias puede evolucionar y adaptarse a nuevas condiciones, convirtiéndose en un activo estratégico para la institución~\cite{silwattananusarn2012}.  
=======
							La información se convierte en un recurso estratégico para organizaciones gracias a su capacidad de apoyar decisiones, automatizar procesos, mejorar la eficiencia organizacional y orientar políticas o acciones informadas. En entornos digitales y de sistemas de información, la generación de información pertinente depende de la calidad de los datos, la adecuación de los algoritmos de procesamiento y la correcta implementación del software que transforma esos datos en insumos útiles para la toma de decisiones~\cite{Horvitz2020Data, Silwattananusarn2012Data}.  .
						}
						
					\subsubsection{Conocimiento: reglas, estructuras y experiencia}
						El conocimiento representa el nivel más sofisticado dentro del ciclo de transformación de datos. Surge cuando la información es interpretada, conectada con experiencias previas y organizada en estructuras que permiten comprender situaciones, anticipar problemas y tomar decisiones~\cite{baskarada2013, Cato2020Transforming}. Aunque los sistemas computacionales pueden almacenar y procesar grandes volúmenes de información, su capacidad de generar conocimiento depende de modelos diseñados por seres humanos o de técnicas avanzadas como aprendizaje automático o sistemas inteligentes~\cite{Spivak2012Ologs}. En este sentido, el conocimiento implica integración, generalización y aplicación real de la información.
						
						En ingeniería de sistemas, el conocimiento se manifiesta como reglas de negocio, políticas organizacionales, modelos de decisión o patrones de comportamiento que guían el funcionamiento del software. Por ejemplo, un sistema académico no solo almacena datos de estudiantes e información de calificaciones; también incorpora conocimiento institucional al aplicar reglas como “aprobar con mínimo 7/10”, “permitir matrícula si no existen deudas” o “generar alertas si el estudiante reprueba tres asignaturas consecutivas”. Estas reglas, diseñadas a partir de experiencia y normativas, permiten que el sistema actúe de manera coherente y confiable~\cite{Bernstein2009Data}.
						
						El conocimiento también se asocia con estructuras mentales y modelos que permiten interpretar la información de manera más profunda. Mientras la información responde al ``qué'', el conocimiento responde al ``por qué'' y ``para qué''. De esta forma, un sistema de información no solo debe presentar datos, sino proveer mecanismos para generar conocimiento útil para gestores, analistas y tomadores de decisiones~\cite{Dammann2019Data,Williams2014Models}.  
						
						La literatura identifica el conocimiento como algo más que datos procesados: es una entidad emergente que requiere interpretación, contexto, experiencia o reglas explícitas -- atributos humanos o estructurales -- para existir. Por ello, la calidad de los datos y la pertinencia del procesamiento influyen directamente en la confiabilidad del conocimiento generado~\cite{Calzati2025Ecosystemic, Cato2020Transforming}. Bajo este enfoque, el conocimiento es esencial para retroalimentar sistemas inteligentes y procesos de mejora continua dentro de organizaciones modernas. Un sistema que aprende de errores, patrones o tendencias puede evolucionar y adaptarse a nuevas condiciones, convirtiéndose en un activo estratégico para la institución~\cite{Silwattananusarn2012Data}.  
>>>>>>> Stashed changes
				...
				\subsection{Datos en sistemas computacionales}
					...
					\AcadBubble{Para su Consideracion}{%
						Los datos en sistemas computacionales se encuentran estructurados según tipos específicos definidos por el lenguaje de programación y por el sistema operativo. Estos tipos permiten especificar el tamaño, formato y operaciones válidas para cada dato, lo que garantiza integridad y minimiza errores durante la ejecución. Esta estructura formal es esencial para el diseño de algoritmos robustos y sistemas confiables.
					}
					
					\subsubsection{Representación interna}
						La representación interna de los datos en una computadora se fundamenta en el sistema binario, en el cual toda la información es codificada mediante secuencias de bits (\textit{binary digits}). Cada bit puede adoptar únicamente uno de dos estados posibles (\texttt{0} o \texttt{1}), lo que permite su implementación física mediante circuitos electrónicos. En la práctica, los bits se agrupan en unidades mayores; un byte está compuesto por ocho bits y constituye la unidad básica de direccionamiento de memoria en la mayoría de las arquitecturas modernas~\cite{Gaddis2022Starting, Patterson2021Computer}. Dependiendo del contexto de interpretación, un mismo patrón binario puede representar un valor numérico, un carácter, una dirección de memoria o una instrucción de máquina.
						
						En el caso de la información textual, los caracteres se representan mediante esquemas de codificación estandarizados. El código ASCII, definido originalmente como un estándar de 7 bits y extendido posteriormente a 8 bits, asigna valores numéricos a letras, dígitos y símbolos de control. Por ejemplo, el carácter \texttt{A} corresponde al valor decimal \texttt{65}, cuya representación binaria es \texttt{01000001}. En sistemas contemporáneos, este esquema ha sido ampliado por estándares como Unicode, que permiten representar alfabetos completos y símbolos internacionales mediante codificaciones como UTF-8 y UTF-16, garantizando interoperabilidad entre sistemas~\cite{ISO10646Information, Unicode2023Standard}.
						
						Los datos numéricos enteros suelen representarse internamente utilizando el esquema de complemento a dos, el cual permite manejar valores positivos y negativos de manera uniforme y eficiente. En esta representación, el bit más significativo indica el signo del número, y las operaciones aritméticas pueden realizarse sin distinguir explícitamente entre números positivos y negativos. Este enfoque es ampliamente utilizado en procesadores modernos debido a su simplicidad de implementación y eficiencia computacional~\cite{Patterson2021Computer, Tanenbaum2021Structured}.
						
						Por su parte, los números reales se representan mediante notación de punto flotante conforme al estándar IEEE 754, el cual define formatos precisos para valores de precisión simple (32 bits) y doble (64 bits). Este estándar divide la representación en tres campos: signo, exponente y mantisa (o fracción), permitiendo representar un amplio rango de valores reales a costa de una precisión finita. Para el programador, este aspecto es crítico, ya que operaciones aritméticas aparentemente simples pueden introducir errores de redondeo y acumulación numérica, especialmente en cálculos iterativos o científicos~\cite{IEEE2019Standard754, Goldberg1991What}.
						
						La representación interna también está influenciada por características arquitectónicas como el \textit{endianness}, que determina el orden en que los bytes de un dato multibyte se almacenan en memoria (big-endian o little-endian), y por las reglas de alineación de datos, que afectan el rendimiento y la correcta lectura de la información. Un manejo inadecuado de estas características puede provocar errores sutiles, como lecturas incorrectas de datos o fallos de interoperabilidad entre sistemas heterogéneos~\cite{Tanenbaum2021Structured}.
						
						Finalmente, desde la perspectiva del programador, es fundamental comprender que la interpretación de un conjunto de bits depende estrictamente del tipo de dato y del contexto en el que se utilice. Un mismo bloque de memoria puede ser interpretado como entero, carácter o instrucción según el módulo que lo procese. Esta flexibilidad es esencial para la ejecución de programas, pero exige disciplina en el diseño del software, el uso correcto de tipos de datos y el respeto a los estándares de representación, con el fin de evitar errores de interpretación, corrupción de datos y vulnerabilidades de seguridad~\cite{ISO247722024Programming, Seacord2013Secure}.
...
=======
			Los algoritmos constituyen la base operativa de todo sistema computacional, pues describen de forma precisa y finita la secuencia de pasos necesaria para transformar datos de entrada en resultados válidos. Su estudio permite comprender cómo los sistemas realizan procesos de decisión, cálculo y control, integrándose con los fundamentos conceptuales presentados en el capítulo anterior, donde se estableció el papel central de la información y su procesamiento en los sistemas computacionales~\cite{Sommerville2015Software,Pressman2019Software,Silberschatz2018Operating}. La formalización algorítmica, además, posibilita la automatización fiable de tareas y asegura que las soluciones obtenidas sean reproducibles, verificables y coherentes bajo distintos escenarios de ejecución~\cite{Tanenbaum2021Structured,Spivak2012Ologs}.
>>>>>>> Stashed changes
...
=======
				Finalmente, estos conceptos fundamentales se conectan con la estructura lógica que compone todo algoritmo, la cual se desarrolla en secciones posteriores. Dicha estructura--secuencia, selección e iteración--ha sido ampliamente discutida en la literatura y constituye el fundamento de los lenguajes imperativos modernos~\cite{Pressman2019Software,Abid2020Years}. Con ello se establece un marco conceptual coherente para interpretar, analizar y diseñar algoritmos robustos, eficientes y verificables.
>>>>>>> Stashed changes
...
=======
					En el contexto de los sistemas computacionales, el seguimiento del estado permite comprender cómo los datos fluyen y se transforman a lo largo del algoritmo, lo cual coincide con los principios de representación y manipulación del conocimiento señalados por Silberschatz et al.~\cite{Silberschatz2018Operating} y por Spivak y Kent~\cite{Spivak2012Ologs}. Esta visión es especialmente útil en la depuración, ya que los errores suelen manifestarse como estados inesperados o inconsistentes que no cumplen las condiciones definidas.
>>>>>>> Stashed changes
	...
	FinAlgoritmo \end{lstlisting}
					...
					\subsubsection{Comparación por igualdad}
						La comparación por igualdad permite verificar si dos valores representan el mismo estado o condición, constituyendo la base de numerosas estructuras de control en algoritmos. Esta operación es esencial para la toma de decisiones, así como para validar entradas y detectar inconsistencias~\cite{Sommerville2015Software,Pressman2019Software}. En términos de diseño algorítmico, su correcta interpretación evita errores comunes al diferenciar asignación de comparación, una confusión típica entre programadores principiantes.
	...
	FinAlgoritmo \end{lstlisting}
					...
					\subsubsection{Operación de entrada}
						...
						Además, Sommerville~\cite{Sommerville2015Software} subraya la necesidad de diseñar mecanismos de entrada robustos y claros, especialmente en sistemas de información donde los datos constituyen el recurso principal. Para programadores principiantes, comprender esta operación implica reconocer que no se modifica el estado interno hasta que el valor ingresado se asigna a una variable, reforzando la separación entre adquisición y procesamiento.
	...
	FinAlgoritmo \end{lstlisting}
					...
					\subsubsection{Operación lógica AND}
						...
						\textbf{Ejercicio.} Diseñe un algoritmo que verifique si un estudiante aprueba cuando \texttt{nota >= 70 AND asistencia >= 80}. Una de sus soluciones se muestra en el listado de código \ref{alg:aprobacionEstudiante}
	...
	FinAlgoritmo \end{lstlisting}
					...
					\subsubsection{Operación lógica OR}
						...
						Para programadores, OR ofrece una comprensión más amplia de los mecanismos de decisión, mostrando cómo distintos criterios pueden habilitar una misma acción. En hardware, OR corresponde a un componente fundamental en puertas digitales, lo que explica su eficiencia y universalidad~\cite{Stallings2021Computer}.
	...
	FinAlgoritmo \end{lstlisting}
					...
					\subsubsection{Variables vs. constantes}
						Las variables representan espacios de memoria cuyo contenido puede cambiar, mientras que las constantes almacenan valores fijos. Pressman \& Maxim~\cite{Pressman2019Software} señalan que distinguir ambas es clave para garantizar claridad semántica en los algoritmos. Silberschatz et al.~\cite{Silberschatz2018Operating} indican que el uso adecuado de constantes evita errores relacionados con modificaciones no deseadas.
...
=======
						La representación conceptual del estado consiste en visualizar las variables del algoritmo y sus valores en un instante específico. Sommerville~\cite{Sommerville2015Software} destaca que esta representación es esencial para depurar y verificar la lógica del algoritmo. Spivak y Kent~\cite{Spivak2012Ologs} indican que un modelo claro del estado permite razonar formalmente sobre la transición entre estados.
>>>>>>> Stashed changes
						...
						La Figura~\ref{fig:memoriaBytes} muestra una representación conceptual de cómo dos variables enteras, \texttt{contador} y \texttt{acumulador}, se almacenan en memoria principal. Cada entero ocupa cuatro bytes consecutivos; en este ejemplo, \texttt{contador} reside desde la dirección hexadecimal 0x1200 hasta 0x1203, mientras que \texttt{acumulador} se ubica desde 0x1204 hasta 0x1207. La columna de la derecha ilustra de forma didáctica el bloque de cuatro bytes reservado para cada variable, representado por un rectángulo con el valor lógico almacenado en su interior. Este modelo ayuda a los programadores a visualizar que una variable de alto nivel no corresponde a una única posición física, sino a un conjunto de direcciones contiguas, y constituye la base para comprender cómo las operaciones de actualización actúan sobre el estado almacenado en memoria.
	...
	FinAlgoritmo \end{lstlisting}
					...
					\begin{lstlisting}[caption={Algoritmo secuencial para enviar un correo electrónico},label={alg:secuencia2}]
	...
	FinAlgoritmo \end{lstlisting}
					...
					\textbf{Ejercicio 3:} Diseñe un algoritmo secuencial que calcule el doble y el triple de un número ingresado. La solución (ver el algoritmo listado de código \ref{alg:secuencial3}) introduce operaciones matemáticas elementales siguiendo el flujo secuencial. El valor de doble y triple depende directamente del valor leído en el paso 2.
	...
	4. doble <- 2 * n
	5. triple <- 3 * n
	6. Escribir doble, triple
	FinAlgoritmo \end{lstlisting}
					\noindent
					En el planteamiento de algoritmos, la declaración explícita de las variables junto con su tipo de dato no es estrictamente obligatoria, dado que los algoritmos están concebidos principalmente como herramientas de representación lógica orientadas a la comprensión humana. En este nivel, el objetivo central es describir con claridad el proceso de resolución de un problema, independientemente de las restricciones sintácticas de un lenguaje de programación concreto. Sin embargo, especificar los tipos de dato resulta una práctica altamente recomendable, ya que reduce la ambigüedad en la interpretación del algoritmo y orienta correctamente a quien posteriormente deba traducirlo a un lenguaje de programación, especialmente si este es fuertemente tipado. La ausencia de esta información puede dar lugar a decisiones erróneas durante la codificación, como el uso de tipos incompatibles o inadecuados, afectando el funcionamiento correcto del programa final. Por ello, aun cuando los algoritmos no lo exijan formalmente, la tipificación explícita contribuye a una comunicación más precisa y a una transición más segura entre el diseño algorítmico y su implementación.
	...
	2. Leer metros
	3. centimetros <- metros * 100
	4. milimetros <- metros * 1000
	5. Escribir centimetros, milimetros
	FinAlgoritmo \end{lstlisting}
	...
	FinAlgoritmo \end{lstlisting}
				...
				\subsection{Selección}
					...
					Por lo tanto, la estructura de selección posee un alto valor pedagógico porque facilita que el programador principiante comprenda cómo los algoritmos “toman decisiones”. Tal como explican Joyanes Aguilar y otros autores, el uso didáctico de estructuras condicionales permite vincular problemas cotidianos con soluciones computacionales formales, favoreciendo la adquisición progresiva del pensamiento algorítmico~\cite{Joyanes2007Fundamentos,Cormen2022Introduction,Farrell2018Programming}. La capacidad de modelar decisiones en un algoritmo constituye uno de los pilares fundamentales de la programación imperativa.
	...
	1. Var
	1.1. fechaActual, fechaCaducidad: fecha
	
	2. Leer fechaActual
	3. Leer fechaCaducidad
	4. Si fechaActual <= fechaCaducidad entonces
	5.     Escribir "El alimento está en buen estado"
	6. SiNo
	7.     Escribir "El alimento está caducado"
	8. FinSi
	FinAlgoritmo \end{lstlisting}
	...
	2. Leer a, b, c
	3. Si (a >= b) Y (a >= c) entonces
	4.     Escribir a
	5. SiNo
	6.     Si (b >= a) Y (b >= c) entonces
	7.         Escribir b
	8.     SiNo
	9.         Escribir c
	10.     FinSi
	...
	1. Var
	1.1. usuario, clave: cadena
	
	2. Leer usuario
	3. Leer clave
	4. Si (usuario = "admin") Y (clave = "1234") entonces
	5.     Escribir "Acceso permitido"
	6. SiNo
	7.     Escribir "Acceso denegado"
	8. FinSi
	FinAlgoritmo \end{lstlisting}
	...
	1. Var
	1.1. precioUnitario, totalPagar, descuento, subtotal: real
	1.2. cantidad: entero
	
	2. Escribir "Ingrese el precio unitario del artículo:"
	3. Leer precioUnitario
	
	4. Escribir "Ingrese la cantidad solicitada:"
	5. Leer cantidad
	
	6. subtotal <- precioUnitario * cantidad
	
	7. Si cantidad > 3 entonces
	8.     descuento <- subtotal * 0.25
	9.     totalPagar <- subtotal - descuento
	10. SiNo
	11.    totalPagar <- subtotal
	12. FinSi
	
	13. Escribir "Subtotal: ", subtotal
	14. Escribir "Total a pagar: ", totalPagar
	...
	1. Var
	1.1. a, b, contador, resultado: entero
	
	2. Leer a
	3. Leer b
	4. resultado <- 1
	5. contador <- 1
	6. Mientras contador <= b hacer
	7.     resultado <- resultado * a
	...
	1. Var
	1.1. totalPasos., contador: entero
	
	2. Leer totalPasos
	3. contador <- 1
	4. Mientras contador <= totalPasos hacer
	5.     Escribir "Paso ", contador
	6.     contador <- contador + 1
	7. FinMientras
	FinAlgoritmo \end{lstlisting}
	...
	1. Var
	1.1. nivel, capacidad: entero
	
	2. Escribir "Número de vasos de agua de capacidad del recipiente"
	3. Leer capacidad
	4. nivel <- 0
	5. Mientras nivel < capacidad hacer
	6.     nivel <- nivel + 1
	7.     Escribir "Nivel actual: ", nivel
	8. FinMientras
	9. Escribir "Su nivel de llenado está al máximo"
	FinAlgoritmo \end{lstlisting}
	...
	1. Var
	1.1. n, contador, totalPares: entero
	...
	FinAlgoritmo \end{lstlisting}
					...
					Este método elimina por completo la necesidad de iterar, ya que la respuesta puede calcularse con una sola operación. Para programadores principiantes, este resultado muestra que, aunque la iteración es útil para comprender la lógica paso a paso, muchos problemas pueden resolverse de manera más eficiente usando propiedades matemáticas básicas.
	...
	Algoritmo AhorroAcumulado
	1. Var
	1.1. ahorro, ahorroInicial, incremento: real
	1.2. periodos, contador: entero
	
	2. Leer ahorroInicial
	3. Leer incremento
	4. Leer periodos
	5. ahorro <- ahorroInicial
	6. contador <- 1
	7. Mientras contador <= periodos hacer
	8.     ahorro <- ahorro + incremento
	9.     contador <- contador + 1
	10. FinMientras
	11. Escribir ahorro
	FinAlgoritmo \end{lstlisting}
	...
	FinAlgoritmo \end{lstlisting}
				...
				\subsection{Estructura Entrada–Proceso–Salida}
					...
					Desde la perspectiva pedagógica, el modelo EPS permite a los programadores distinguir claramente el rol de cada parte del algoritmo, lo cual es especialmente importante cuando se introducen los conceptos de variables, instrucciones y operaciones de transformación. Tal como plantea Sommerville~\cite{Sommerville2015Software}, la claridad en la separación entre datos y procesamiento contribuye a reducir errores conceptuales y facilita el proceso de diseño. La estructura EPS actúa como un puente entre el razonamiento cotidiano y el pensamiento computacional, permitiendo que el programador en formación identifique qué información es necesaria y cómo esta debe manipularse para resolver un problema.
	...
	FinAlgoritmo \end{lstlisting}
						...
						\begin{lstlisting}[caption={Verificación de divisibilidad},label={alg:SituacionEstudiante}]
	Algoritmo VerificarDivisibilidad
	1. Var
	...
	FinAlgoritmo \end{lstlisting}
			...
			\AcadBubble{Buenas prácticas}{
				Se recomienda verificar mentalmente o por escrito el funcionamiento del algoritmo con distintos valores de entrada antes de implementarlo. Probar casos como \(n = 12\), \(n = 7\) o \(n = 1\) permite confirmar que los mensajes especiales aparecen únicamente cuando corresponde y que la cuenta regresiva finaliza correctamente. Este hábito de validación temprana es esencial para desarrollar algoritmos correctos y confiables desde las primeras etapas de la formación en programación.
			}
			
			\section{Resolver Problemas Mediante Algoritmos}
			\noindent
...
<<<<<<< Updated upstream
					En este sentido, se consideran datos de entrada todos aquellos valores que influyen en el resultado y que no pueden ser obtenidos mediante cálculos internos ni generados automáticamente por el sistema. Estos datos deben ser proporcionados necesariamente por el usuario o por una fuente externa confiable. Por ejemplo, en el cálculo del promedio de calificaciones, las notas individuales constituyen datos de entrada, mientras que el criterio de aprobación —como una calificación mínima de 7/10— puede modelarse como una constante definida por las reglas del sistema \cite{Halterman2018}. Esta distinción favorece un diseño algorítmico más claro, coherente y alineado con las buenas prácticas de programación.
=======
...
>>>>>>> Stashed changes
					...
					Finalmente, la identificación de los datos de entrada implica también definir su tipo y sus restricciones. El programador en formación debe habituarse a determinar si un dato es entero, real, carácter o conjunto de valores, así como los rangos válidos que puede asumir. Esta práctica resulta esencial para prevenir errores lógicos y facilita la validación temprana de datos, una recomendación recurrente en la ingeniería de software contemporánea \cite{Sommerville2015Software}.
...
<<<<<<< Updated upstream
					Por ejemplo, en un algoritmo que simula un cronómetro, el tiempo restante mostrado en cada iteración constituye una salida informativa de carácter secundario, mientras que el mensaje final indica la culminación del proceso y actúa como salida principal. De manera similar, en la resolución del problema de calcular el promedio y la desviación estándar de un conjunto de valores, los resultados intermedios —como la suma de los datos y la varianza— pueden considerarse salidas secundarias si se muestran al usuario, mientras que el promedio y la desviación estándar representan las salidas principales del algoritmo \cite{Halterman2018,Knuth1997Art}.
=======
...
>>>>>>> Stashed changes
				...
				\noindent
<<<<<<< Updated upstream
					Las repeticiones se utilizan cuando un conjunto de acciones debe ejecutarse múltiples veces. Para identificarlas, se deben buscar en el enunciado indicios como \textit{para cada}, \textit{mientras}, \textit{repetir} o \textit{hasta que}. Estos términos sugieren la necesidad de una estructura iterativa \cite{Halterman2018}.
=======
...
>>>>>>> Stashed changes
				...
				\subsection{Condiciones para terminar el algoritmo}
				\noindent
<<<<<<< Updated upstream
					Todo algoritmo debe tener un punto claro de terminación. En algoritmos simples, este punto coincide con la ejecución de la última instrucción. En algoritmos que incluyen ciclos, la terminación depende del cumplimiento de una condición de salida correctamente definida \cite{Halterman2018}.
=======
...
>>>>>>> Stashed changes
			...
			% Símbolos, construcción y lectura de diagramas.
				...
				\subsection{Construcción de diagramas}
                    La construcción de diagramas constituye una etapa fundamental en el proceso de desarrollo de algoritmos, ya que permite representar gráficamente la lógica de solución de un problema antes de su implementación en un lenguaje de programación. En el contexto de la ingeniería de sistemas de información, los diagramas —en particular los diagramas de flujo— facilitan la comprensión del comportamiento del sistema, la secuencia de operaciones y las decisiones involucradas, actuando como un puente entre el análisis del problema y la codificación del algoritmo. Diversos estudios destacan que el uso de representaciones gráficas mejora la comprensión cognitiva de los procesos algorítmicos, especialmente en etapas tempranas de formación en programación~\cite{Hooshyar2015Flowchart}.
                    
                    Desde una perspectiva formal, un diagrama de flujo es una representación gráfica de un algoritmo que utiliza símbolos estandarizados para describir operaciones, decisiones y flujos de control. Su uso permite identificar errores lógicos, redundancias y omisiones antes de la implementación, reduciendo costos de corrección posteriores. Autores clásicos en ciencias de la computación señalan que los diagramas de flujo contribuyen a la claridad estructural del algoritmo y fomentan una programación más ordenada y modular~\cite{Knuth1997Art, Pressman2019Software}.
                    
                    En sistemas de información, los diagramas no solo describen cálculos, sino también reglas de negocio, validaciones y flujos de decisión organizacional. Por esta razón, su correcta construcción es esencial para asegurar que el software refleje fielmente los procesos institucionales que pretende automatizar. La estandarización de símbolos y la claridad del flujo lógico son aspectos clave para garantizar que los diagramas sean comprensibles por distintos actores del proyecto, incluidos analistas, programadores y usuarios finales~\cite{Leewis2019Notational}.
                    
                    \subsubsection{Consejos para la correcta construcción de diagramas}
                        Desde el punto de vista práctico, un diagrama de flujo debe construirse después de comprender completamente el problema, nunca como un ejercicio improvisado. Es recomendable comenzar identificando claramente las entradas, procesos, decisiones y salidas, asegurando que cada elemento tenga una función precisa dentro del algoritmo. Todo diagrama debe iniciar con un símbolo de inicio y finalizar con un símbolo de término, evitando flujos abiertos o ambiguos.
                    
                        Asimismo, se recomienda que los diagramas mantengan una dirección lógica única, generalmente de arriba hacia abajo y de izquierda a derecha, evitando cruces innecesarios de líneas. Cada decisión debe formularse como una condición clara con dos salidas bien definidas, y cada proceso debe representar una operación concreta y verificable. Un buen diagrama no busca ser decorativo, sino preciso, legible y coherente.
                    
                    \subsubsection{Ejercicios}
					   
                       % =========================================================
                       % Diagrama de flujo (TikZ) — Promedio de 10 valores
                       % (Corrección solicitada: SOLO la flecha de retorno desde i ← i + 1
                       %  debe rodear y unirse a la línea vertical que baja a la condición)
                       % =========================================================
				...
				\subsection{Correspondencia con pseudocódigo}
                    El pseudocódigo es una herramienta intermedia entre el lenguaje natural y el lenguaje de programación formal. Su función principal es describir la lógica del algoritmo de manera estructurada y legible, sin depender de la sintaxis específica de un lenguaje de programación. En la enseñanza de la programación básica, el pseudocódigo facilita la transición conceptual desde la formulación del problema hasta su implementación, permitiendo al programador en formación concentrarse en el razonamiento algorítmico más que en detalles sintácticos~\cite{LopezGarcia2025Improving}.
                    
                    La correspondencia entre pseudocódigo y diagramas de flujo es directa: cada bloque del diagrama tiene su equivalente textual en el pseudocódigo. Los procesos se traducen en instrucciones secuenciales, las decisiones en estructuras condicionales y los ciclos en estructuras repetitivas. Esta dualidad fortalece la comprensión del algoritmo, ya que el programador en formación puede analizar la solución tanto desde una perspectiva visual como textual, reforzando el aprendizaje significativo~\cite{Milne2002Programming}.
					
			\section{Refinamiento Sucesivo y Descomposición}
				\noindent
				El refinamiento sucesivo es una técnica fundamental en el diseño algorítmico que consiste en abordar un problema complejo dividiéndolo progresivamente en partes más simples y manejables. En lugar de intentar resolver el problema completo de una sola vez, el programador comienza con una descripción general de la solución y luego va refinando cada parte hasta llegar a instrucciones precisas y ejecutables. Por ejemplo, al desarrollar un sistema de gestión académica, el problema general puede definirse como “administrar estudiantes”, pero este objetivo se refina en tareas como registrar estudiantes, calcular promedios, controlar matrículas y generar reportes~\cite{Gaddis2022Starting}.
				
<<<<<<< Updated upstream
				Este enfoque resulta especialmente útil cuando el problema involucra múltiples pasos o reglas. Consideremos el caso de un programa que calcula la nómina de una empresa. A primera vista, puede parecer un problema simple; sin embargo, al analizarlo se identifican subprocesos como la lectura de datos del empleado, el cálculo de horas trabajadas, la aplicación de impuestos y la generación del comprobante de pago. El refinamiento sucesivo permite tratar cada uno de estos elementos de forma independiente, reduciendo la complejidad cognitiva del diseño~\cite{Halterman2018}.
=======
				Este enfoque resulta especialmente útil cuando el problema involucra múltiples pasos o reglas. Consideremos el caso de un programa que calcula la nómina de una empresa. A primera vista, puede parecer un problema simple; sin embargo, al analizarlo se identifican subprocesos como la lectura de datos del empleado, el cálculo de horas trabajadas, la aplicación de impuestos y la generación del comprobante de pago. El refinamiento sucesivo permite tratar cada uno de estos elementos de forma independiente, reduciendo la complejidad cognitiva del diseño~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
				
				Desde el punto de vista didáctico, el refinamiento sucesivo ayuda al programador en formación a organizar su pensamiento lógico. En lugar de escribir código de forma improvisada, se fomenta una planificación estructurada que facilita la detección temprana de errores conceptuales. Por ejemplo, al diseñar un algoritmo para procesar ventas, es más sencillo verificar la corrección del cálculo del total si este se ha separado claramente del proceso de lectura de productos o de la impresión de resultados~\cite{Pressman2019Software}.
				
				Otro beneficio del refinamiento sucesivo es que favorece la reutilización del conocimiento. Un subproblema bien definido, como el cálculo de un promedio o la validación de datos de entrada, puede reutilizarse en otros programas o módulos. Esto no solo mejora la productividad del programador, sino que también promueve buenas prácticas de diseño desde las primeras etapas del aprendizaje~\cite{McConnell2004Code}.
				
				Finalmente, el refinamiento sucesivo establece un puente natural hacia el diseño modular y la programación estructurada. Al dividir un problema en subproblemas, se crean las bases para implementar funciones, procedimientos o módulos independientes. Este enfoque no solo facilita la implementación, sino que también mejora la legibilidad, el mantenimiento y la evolución del software, aspectos clave en sistemas reales~\cite{Sommerville2015Software}.
				
				\subsection{De un Problema Grande a Subproblemas}
					\noindent
					El proceso de descomposición comienza identificando el objetivo principal del problema y formulándolo de manera clara. Por ejemplo, si el problema consiste en “analizar el rendimiento académico de un curso”, el programador puede identificar subproblemas como ingresar calificaciones, calcular estadísticas (promedio, máximo, mínimo) y generar un informe final. Cada uno de estos subproblemas puede abordarse de forma independiente, simplificando el diseño global del algoritmo~\cite{Gaddis2022Starting}.
					
<<<<<<< Updated upstream
					Una vez identificados los subproblemas, se procede a descomponerlos aún más si es necesario. Siguiendo el ejemplo anterior, el subproblema “calcular estadísticas” puede dividirse en “sumar calificaciones”, “contar estudiantes” y “determinar valores extremos”. Esta descomposición progresiva permite llegar a operaciones elementales que el programador puede implementar fácilmente utilizando estructuras básicas como bucles y condicionales~\cite{Halterman2018}.
=======
					Una vez identificados los subproblemas, se procede a descomponerlos aún más si es necesario. Siguiendo el ejemplo anterior, el subproblema “calcular estadísticas” puede dividirse en “sumar calificaciones”, “contar estudiantes” y “determinar valores extremos”. Esta descomposición progresiva permite llegar a operaciones elementales que el programador puede implementar fácilmente utilizando estructuras básicas como bucles y condicionales~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
					
					Este enfoque resulta especialmente útil en problemas del mundo real. Por ejemplo, en un sistema de control de inventarios, el problema general puede dividirse en registrar productos, actualizar existencias y generar alertas de stock bajo. Cada subproblema refleja una responsabilidad concreta del sistema, lo que facilita tanto el diseño del algoritmo como su posterior implementación en código~\cite{Sommerville2015Software}.
					
				\subsection{Construcción de un árbol de descomposición}
					El árbol de descomposición es una representación gráfica que muestra cómo un problema principal se divide en subproblemas y, a su vez, en tareas más específicas. En este árbol, el nodo raíz representa el problema general, mientras que los nodos hijos representan los subproblemas identificados. Esta representación ayuda a visualizar la estructura lógica del algoritmo antes de escribir una sola línea de código~\cite{Pressman2019Software}.
					
					El primer paso para construir un árbol de descomposición consiste en definir claramente el problema principal. A continuación, se identifican las tareas principales necesarias para resolverlo, las cuales se colocan como nodos de primer nivel. Por ejemplo, en un sistema de facturación, estos nodos podrían ser “capturar datos”, “calcular montos” y “emitir factura”. Cada uno de estos nodos puede subdividirse posteriormente en tareas más específicas~\cite{McConnell2004Code}.
					
					El siguiente paso es verificar que cada subproblema sea lo suficientemente simple como para ser implementado directamente. Si un nodo sigue siendo complejo, debe descomponerse nuevamente. Este proceso continúa hasta que todos los nodos hoja del árbol representen acciones claras y concretas, como leer un valor, realizar un cálculo o mostrar un resultado~\cite{Gaddis2022Starting}.
					
					Para apoyar este proceso, existen herramientas CASE (Computer-Aided Software Engineering) que permiten modelar gráficamente la descomposición de problemas. Herramientas como Visual Paradigm, StarUML o draw.io facilitan la creación de diagramas jerárquicos y ayudan a mantener coherencia entre el análisis y el diseño. Estas herramientas son ampliamente utilizadas tanto en entornos académicos como profesionales~\cite{Tegarden2025Systems}.
					
					\AcadBubble{Práctica de Ingeniería}{
						El árbol de descomposición sirve como guía durante la implementación del algoritmo. Cada rama del árbol puede traducirse en funciones o procedimientos, asegurando que el código final refleje fielmente el diseño conceptual. Esta correspondencia entre diseño y código reduce errores y mejora la comprensión del programa por parte de otros desarrolladores~\cite{Sommerville2015Software}.
					}
					
				\subsection{Ventajas del Diseño Modular}
					Una de las principales ventajas del diseño modular es la facilidad de comprensión. Al dividir un programa en módulos pequeños y bien definidos, el programador puede concentrarse en una parte específica del problema sin necesidad de comprender todo el sistema simultáneamente. Por ejemplo, un módulo dedicado al cálculo de promedios puede analizarse y probarse de forma aislada.
					
					Otra ventaja importante es la reutilización del código. Un módulo correctamente diseñado puede emplearse en diferentes programas o contextos sin modificaciones significativas. Por ejemplo, un módulo de validación de datos puede reutilizarse en aplicaciones académicas, financieras o administrativas~\cite{McConnell2004Code}.
					
					El diseño modular también mejora la mantenibilidad del software. Cuando se requiere modificar una parte del sistema, el cambio puede realizarse en el módulo correspondiente sin afectar al resto del programa. Esto es especialmente valioso en sistemas que evolucionan con el tiempo, como los sistemas de información institucionales~\cite{Sommerville2015Software}.
					
<<<<<<< Updated upstream
					Otra ventaja clave es la facilidad para detectar y corregir errores. Al trabajar con módulos pequeños, el programador puede probar cada uno de forma independiente, lo que reduce el tiempo necesario para localizar fallos. Por ejemplo, si un resultado es incorrecto, se puede identificar rápidamente si el error está en el módulo de cálculo o en el de entrada de datos~\cite{Halterman2018}.
=======
					Otra ventaja clave es la facilidad para detectar y corregir errores. Al trabajar con módulos pequeños, el programador puede probar cada uno de forma independiente, lo que reduce el tiempo necesario para localizar fallos. Por ejemplo, si un resultado es incorrecto, se puede identificar rápidamente si el error está en el módulo de cálculo o en el de entrada de datos~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
					
					\AcadBubble{Practica de Ingeniería}{
						El diseño modular fomenta el trabajo colaborativo. En proyectos más grandes, distintos programadores pueden trabajar en módulos diferentes de manera simultánea, siempre que las interfaces estén claramente definidas. Este enfoque es ampliamente utilizado en el desarrollo profesional de software~\cite{Pressman2019Software}.
					}
				
			\section{Errores típicos en el diseño algorítmico}
				Durante el aprendizaje de la programación, es común cometer errores en el diseño de algoritmos que no se deben a la sintaxis del lenguaje, sino a fallos conceptuales en la lógica. Estos errores pueden provocar resultados incorrectos, comportamientos inesperados o incluso la imposibilidad de ejecutar el programa. Reconocerlos y comprender sus causas es una parte esencial de la formación del programador~\cite{Gaddis2022Starting}.
				
<<<<<<< Updated upstream
				Uno de los errores más frecuentes es no considerar todos los escenarios posibles del problema. Por ejemplo, al diseñar un algoritmo para calcular el promedio de calificaciones, el programador puede olvidar el caso en el que no existan datos de entrada, lo que puede generar divisiones por cero o resultados inválidos~\cite{Halterman2018}.
=======
				Uno de los errores más frecuentes es no considerar todos los escenarios posibles del problema. Por ejemplo, al diseñar un algoritmo para calcular el promedio de calificaciones, el programador puede olvidar el caso en el que no existan datos de entrada, lo que puede generar divisiones por cero o resultados inválidos~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
				
				Otro error común se relaciona con el uso incorrecto de estructuras de control. Condiciones mal formuladas o bucles mal diseñados pueden conducir a resultados incorrectos o a programas que nunca terminan su ejecución. Estos errores suelen aparecer cuando el algoritmo no ha sido cuidadosamente analizado antes de su implementación~\cite{Pressman2019Software}.
				
				\AcadBubble{Errores lógicos}{
					Existen errores derivados de una mala interpretación del problema original. Cuando el algoritmo no refleja fielmente los requisitos planteados, el programa puede funcionar correctamente desde el punto de vista técnico, pero no resolver el problema real. Este tipo de error resalta la importancia del análisis previo y del diseño cuidadoso del algoritmo~\cite{Sommerville2015Software}.
				}
				
				\subsection{Casos no contemplados}
					Un caso no contemplado ocurre cuando el algoritmo no considera situaciones excepcionales o límites del problema. Por ejemplo, un programa que calcula descuentos puede funcionar correctamente para valores positivos, pero fallar si el monto de compra es cero o negativo. Estos casos suelen pasar desapercibidos si el diseño se enfoca solo en el escenario “normal” del problema~\cite{Gaddis2022Starting}.
					
				\subsection{Condiciones incompletas}
<<<<<<< Updated upstream
					Las condiciones incompletas aparecen cuando una estructura condicional no cubre todas las posibilidades. Por ejemplo, en un algoritmo que clasifica notas como “aprobado” o “reprobado”, puede olvidarse el caso intermedio de una nota inválida, como un valor mayor al máximo permitido. Esto puede provocar resultados incorrectos o comportamientos inesperados~\cite{Halterman2018}.
=======
					Las condiciones incompletas aparecen cuando una estructura condicional no cubre todas las posibilidades. Por ejemplo, en un algoritmo que clasifica notas como “aprobado” o “reprobado”, puede olvidarse el caso intermedio de una nota inválida, como un valor mayor al máximo permitido. Esto puede provocar resultados incorrectos o comportamientos inesperados~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
					
					Otro ejemplo típico se presenta en sistemas de control, donde se evalúan rangos de valores. Si los límites no se definen correctamente, ciertos valores pueden no cumplir ninguna condición, dejando al algoritmo sin una respuesta clara. Este tipo de error es frecuente en programadores en formación~\cite{Pressman2019Software}.
					
					\AcadBubble{Buenas Prácticas de Programación}{
						Las condiciones incompletas pueden generar errores difíciles de detectar, ya que el programa puede funcionar correctamente en la mayoría de los casos. Por ello, es fundamental analizar exhaustivamente todas las posibles entradas y validar las condiciones utilizadas~\cite{Sommerville2015Software}.
					}
					
				\subsection{Ciclos sin salida}
<<<<<<< Updated upstream
					Un ciclo sin salida ocurre cuando la condición de terminación nunca se cumple. Por ejemplo, un bucle que incrementa una variable de forma incorrecta puede ejecutarse indefinidamente. Este error suele aparecer cuando el programador no verifica adecuadamente la evolución de las variables de control dentro del ciclo~\cite{Halterman2018}.
=======
					Un ciclo sin salida ocurre cuando la condición de terminación nunca se cumple. Por ejemplo, un bucle que incrementa una variable de forma incorrecta puede ejecutarse indefinidamente. Este error suele aparecer cuando el programador no verifica adecuadamente la evolución de las variables de control dentro del ciclo~\cite{Halterman2018Fundamentals}.
>>>>>>> Stashed changes
					
					Otro caso común se presenta cuando la condición de salida depende de una entrada externa que nunca cambia, como esperar indefinidamente una señal que no se produce. Este tipo de error destaca la importancia de diseñar condiciones de salida claras y verificables~\cite{Pressman2019Software}.
					
				\subsection{Inconsistencias con el problema}
					Una inconsistencia frecuente ocurre cuando el algoritmo resuelve un problema diferente al planteado. Por ejemplo, un programa diseñado para calcular promedios puede devolver la suma total por un error en la interpretación del objetivo. Aunque el código se ejecute sin fallos y los cálculos internos sean correctos desde el punto de vista computacional, el resultado final no satisface la necesidad original del usuario o del sistema~\cite{Sommerville2015Software}.
					
					Un tipo particular de inconsistencia, especialmente común en sistemas con interfaz gráfica o reportes automatizados, se presenta cuando el procesamiento interno es correcto, pero la información mostrada al usuario no corresponde con lo que realmente se ha calculado. Por ejemplo, un sistema estadístico puede calcular correctamente tanto la varianza como la desviación estándar de un conjunto de datos; sin embargo, si la interfaz indica que se está mostrando la desviación estándar cuando en realidad se presenta el valor de la varianza, el usuario recibe información incorrecta, aun cuando el algoritmo subyacente funcione adecuadamente. Este tipo de error no es lógico ni matemático, sino semántico y comunicacional.
					
					Situaciones similares pueden ocurrir en sistemas financieros, donde el motor de cálculo determina correctamente el interés compuesto, pero la interfaz presenta el valor como si fuera interés simple, o en sistemas de inventario donde el stock real se actualiza correctamente en la base de datos, pero el reporte visual muestra únicamente el stock inicial sin reflejar las entradas y salidas procesadas. En estos casos, el sistema realiza los cálculos correctos, pero falla en la correspondencia entre los resultados internos y su representación externa.
					
					Otra fuente de inconsistencias se da cuando los nombres de variables, etiquetas de salida o descripciones en la documentación no reflejan con precisión la lógica implementada. Por ejemplo, un módulo puede denominarse “cálculo de promedio ponderado” cuando en realidad implementa un promedio aritmético simple. Este desalineamiento entre diseño conceptual, implementación y presentación puede inducir a errores de interpretación, toma de decisiones incorrectas y pérdida de confianza en el sistema, incluso si los cálculos internos son técnicamente válidos~\cite{Gaddis2022Starting}.
					
					Este tipo de inconsistencias pone de manifiesto la importancia de validar no solo la corrección algorítmica, sino también la coherencia entre el problema original, el procesamiento interno y la información que se comunica al usuario final. Para el programador en formación, resulta fundamental comprender que un sistema de información no solo debe “calcular bien”, sino también “explicar bien” lo que calcula, asegurando una alineación clara entre lógica, resultados y presentación.
